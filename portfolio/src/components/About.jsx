...
export default function About() {
  return (
    <div className="about-container">
      ...
      <div className="hero-section">
        <img 
          src="https://media.istockphoto.com/id/532174154/photo/yellow-circuit-and-microchip-closeup.webp?a=1&b=1&s=612x612&w=0&k=20&c=oTIukfzt4sGclSsEOHy8drW3NxEE6JUVLXIXpA5r99Y="  
          alt="About" 
          className="hero-image" 
        />
        <div className="hero-content">
